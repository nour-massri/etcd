module github.com/nour-massri/etcd/v3
...
replace (
	github.com/nour-massri/etcd/client/pkg/v3 => ./client/pkg
	github.com/nour-massri/etcd/client/v2 => ./client/v2
	github.com/nour-massri/etcd/client/v3 => ./client/v3
	github.com/nour-massri/etcd/pkg/v3 => ./pkg
